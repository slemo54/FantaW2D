-- Schema del database per Salvadanaio W2D

-- Creazione del database (se non esiste già)
CREATE DATABASE IF NOT EXISTS `dbymzupboptdzw` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `dbymzupboptdzw`;
...
-- Tabella per le regole malus specifiche dell'utente
CREATE TABLE IF NOT EXISTS `user_malus_rules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Tabella per le regole predefinite di bonus
